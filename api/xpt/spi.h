 ...
 *
 * This file defines the spi interface for libxpt. A Spi object in libxpt
 ...
 */
typedef enum {
    XPT_SPI_MODE0 = 0, /**< CPOL = 0, CPHA = 0, Clock idle low, data is clocked in on rising edge,
                           output data (change) on falling edge */
    XPT_SPI_MODE1 = 1, /**< CPOL = 0, CPHA = 1, Clock idle low, data is clocked in on falling edge,
                           output data (change) on rising edge */
    XPT_SPI_MODE2 = 2, /**< CPOL = 1, CPHA = 0, Clock idle low, data is clocked in on falling edge,
                           output data (change) on rising edge */
    XPT_SPI_MODE3 = 3, /**< CPOL = 1, CPHA = 1, Clock idle low, data is clocked in on rising, edge
                           output data (change) on falling edge */
} xpt_spi_mode_t;
 ...
 */
typedef struct _spi* xpt_spi_context;
...
/**
 * De-inits an xpt_spi_context device
 *
 * @param dev The Spi context
 * @return Result of operation
 */
